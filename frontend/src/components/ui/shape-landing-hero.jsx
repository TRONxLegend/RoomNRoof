...
// Simple cn utility function (in case @/lib/utils doesn't exist)
...
function ShapeLandingHero({
    badge = "Real Estate Excellence",
    title1 = "Find Your Dream Property",
    title2 = "Your Trusted Real Estate Partner",
    description = "Discover the perfect home or investment property. We connect property owners with tenants and help you find your ideal space."
}) {
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6  lg:mt-16 mt-0">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center w-[12rem] h-[4rem]">
                            {badge}
                        </div>
                    </motion.div>
...
export { ShapeLandingHero as HeroGeometric };
